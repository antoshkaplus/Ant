...
#include "ant/graph/model/adj_list/vertex_sub.hpp"
...
template <typename Policy,
    ...
    , int> = 0>
class Graph : public Model_NoEdgeDescriptor<Policy, VertexInfo_1<typename Policy::VertexDescriptor>, VertexSub, Mutator_1> {
public:
};
